...
contract ShitToken is BEP20('ShitSwap Token', 'Shit') {
    ...
    /**
     * @notice Constructs the Shit BEP-20 contract.
     */
    constructor(address _treasury) public {
        // Mints 2500 Shit to treasury, 2000 for airdrop and 500 for meme contest
        treasury = _treasury;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Shit::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Shit::delegateBySig: invalid nonce");
        require(now <= expiry, "Shit::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "Shit::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Shits (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Shit::_writeCheckpoint: block number exceeds 32 bits");
...
contract FoamBar is BEP20('FoamBar Token', 'FOAM') {
    ...
    function safeShitTransfer(address _to, uint256 _amount) public onlyOwner {
